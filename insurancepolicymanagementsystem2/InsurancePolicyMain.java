package com.tit.insurancepolicymanagementsystem2;
...
public class InsurancePolicyMain {
    public static void main(String[] args) {
        ...
        ipm.addPolicy(new Policy("P001", "Ankit Gangwani", LocalDate.now().plusDays(10)));
        ipm.addPolicy(new Policy("P002", "Aadarsh Gupta", LocalDate.now().plusDays(40)));
        ipm.addPolicy(new Policy("P003", "Aditya Raj Gupta", LocalDate.now().minusDays(5)));
